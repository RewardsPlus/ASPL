...
@section('content-area')
 <div class="col-12 d-inline-block">
        <div class="container">
            {!! Form::open(['route'=>'qrcodes.store','files'=>'true']) !!}
            <div class="col-12 d-inline-block">
                <div class="col-md-8 creater-part-scroll position-sticky float-left">
                    <div class="col-12 d-inline-flex flex-column">
                        <div class="step-creation-box col-12 d-inline-block">
                            <h4 class="col-12 d-inline-flex align-items-center"><span class="title-step-box d-inline-flex align-items-center">Step 1.</span> Branding</h4>
                            {!! Form::submit('Save', ['class'=>'btn btn-outline-primary float-end','files'=>true]) !!}
                                ...
                                <div class="col-md-8 d-inline-flex align-items-center">
                                    ...
                                    <div class="logo-upload-btns ms-auto d-inline-flex flex-column">
                                        <span
                                            ...
                                            {!! Form::file('brand_logo_circle', ['class'=>'position-absolute opactiy-0 upload-logo-btn','accept' => "image/*", 'id' => "logo-icon-btn", 'data-image' => "added-logo-icon",'data-image-display' => "logo-icon"]) !!}
                                        </span>
                                        <span
                                ...
                                <div class="col-md-8 d-inline-flex align-items-center">
                                    ...
                                    <div class="logo-upload-btns ms-auto d-inline-flex flex-column">
                                        <span
                                            ...
                                            {!! Form::file('brand_logo_rectangle', ['class' => "position-absolute opactiy-0 upload-logo-btn" ,'accept' => "image/*", 'id' => "full-logo-btn", 'data-image' => "added-logo-rectangle", 'data-image-display' => "full-logo"]) !!}
                                        </span>
                                        <span
                            ...
                            <div class="col-12 d-inline-block mb-3">
                                ...
                                <input type="text" placeholder="Brand Title Name" id="brand-title"
                                    class="col-12 d-inline-block brand-tilte-input" name="brand_name" />
                            </div>
                            <div class="col-12 d-inline-block mb-3">
                                ...
                                <input type="text" placeholder="Brand Title SubLine" id="brand-subline"
                                    class="col-12 d-inline-block brand-tilte-input" name="brand_title"/>
                            </div>
                            <div class="col-12 d-inline-block mb-3">
                                ...
                                <div class="col-12 d-inline-flex justify-content-between">
                                    <div class="d-inline-flex align-items-center ms-3">
                                        ...
                                        <input class="background1" type="color" value="#0000ff" name="background_color" />
                                    </div>
                                    <div class="d-inline-flex align-items-center me-4">
                                        ...
                                        <input class="color1" type="color" value="#0000ff" name="background_gradient" />&nbsp;&nbsp;
                                        <input class="color2" type="color" value="#add8e6" name="background_gradient_1"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="step-creation-box col-12 d-inline-block">
                            <h4 class="col-12 d-inline-flex align-items-center"><span
                                ...
                                URL QR</h4>
                            <div class="col-12 d-inline-block mb-3">
                                <textarea class="d-none" name="custom_url" id="custom_url"></textarea>
                                        ...
                                        <div class="social-block-inner flex-shrink-0 col-md-7">
                                            ...
                                            <div class="social-block col-12 d-inline-flex flex-column">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <input  data-target="brand-shop-label-1" id="brand-title-text-1" maxlength="50" name="custom_url[1][name]"
                                                        class="form-control brand-shop-input ml-1" type="text" placeholder="Title" />
                                                </div>
                                                <div class="d-flex align-items-center gap-2">
                                                    <i class="qr-url social-icon-url"></i>
                                                    <input id="brand-title-url-1" class="form-control brand-shop-input ml-1" name="custom_url[1][url]" type="url" placeholder="URL" data-target-link="brand-shop-box-1"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-inline-flex align-items-center col-md-5">
                                            ...
                                            <div class="logo-upload-btns d-inline-flex align-items-center ms-auto">
                                                <span
                                                    ...
                                                    <input type="file" name="custom_url_1" class="position-absolute opactiy-0 upload-logo-btn" accept="image/*" id="logo-icon-btn-1" data-image="shop-brand-icon-1" data-image-display="shop-logo-icon-1"/>

                                                    {!! Form::file('custom_url_1', ['class' => "position-absolute opactiy-0 upload-logo-btn", 'accept' => "image/*", 'id' => "logo-icon-btn-1", 'data-image' => "shop-brand-icon-1", 'data-image-display' => "shop-logo-icon-1"]) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
